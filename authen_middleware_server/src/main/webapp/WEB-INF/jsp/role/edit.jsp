...
<body>
    ...
    <form:form method="post" commandName="role">
        ...
        <div class="form-group">
            ...
            <input type="text" id="resourceName" name="resourceName" value="${role.resourceIds }" readonly>
            ...
            var zNodes =[
                <c:forEach items="${resourceList}" var="r">
					<c:if test="${not r.rootNode}">
						{ id:"${r.id}", pId:"${r.parentId}", name:"${r.name}", checked:"${role.resources.contains(r.id)}"},
                	</c:if>
                </c:forEach>
            ];
